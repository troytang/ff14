    ...
    constructor(props) {
        ...
        this.state = {
            ...
            dataSource: ds.cloneWithRows([
                ...
                {name: '采矿工', kind: 1, type: 8, icon: require('./img/icon-caikuang.jpg')},
                {name: '园艺工', kind: 1, type: 9, icon: require('./img/icon-yuanyi.jpg')},
                {name: '捕鱼人', kind: 1, type: 10, icon: require('./img/icon-buyu.jpg')},
            ])
        };
