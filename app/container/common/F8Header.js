...
import F8Colors from './F8Colors.js';
import { Text } from './F8Text.js';
...
class F8HeaderAndroid extends React.Component {
    ...
    render() {
        ...
        let containerHeight = (this.props.childrenHeight)
            ? this.props.childrenHeight + HEADER_HEIGHT
            : HEADER_HEIGHT;
        let toolbarHeight = (this.props.childrenHeight)
            ? this.props.childrenHeight + HEADER_HEIGHT - STATUS_BAR_HEIGHT
            : HEADER_HEIGHT - STATUS_BAR_HEIGHT;

        return (
            <View style={[styles.toolbarContainer, {height: containerHeight}]}>
                <Image style={[styles.toolbarContainer, this.props.style, {height: containerHeight}]} source={this.props.background}
                    resizeMode='cover'>
                </Image>
                <ToolbarAndroid
...
global.STATUS_BAR_HEIGHT = Platform.OS === 'ios' ? 20 : 25;
global.HEADER_HEIGHT = Platform.OS === 'ios' ? 44 + STATUS_BAR_HEIGHT : 56 + STATUS_BAR_HEIGHT;
